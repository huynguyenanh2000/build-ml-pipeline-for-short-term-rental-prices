...
def go(args):
    ...
    logging.info("Get the train and validation artifact")
    ...
    ######################################
    logger.info("Save sk_pipe pipeline")
    ...
    logger.info("Upload Model Artifact to Weights & Bias")
